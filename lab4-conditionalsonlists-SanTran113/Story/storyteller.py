...
world   = objects.World("Fantasy", "Nymnean", 1992)
monster = objects.Monster("Naga", "Green", 100)
hero    = objects.Hero("Mel", "traveling", objects.Item("mochi", 300))

# Change this string for task 2:
spell = "abracadabra"
# spell = magic.enchantItem("abracadabra", objects.Item("umbrella", 50))
